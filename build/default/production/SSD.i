...
unsigned char SetNum[10]={0x3F,0x06,0x5B,0x4F,0x66,0x6D,0x7D,0x07,0x7F,0x6F};
unsigned char Num_Digit[2];
unsigned char Select_Seg=0;
...
void Select_Digit(unsigned char Digit)
{
        PORTD = SetNum[Num_Digit[Digit-1]];
        switch(Digit)
        {
            case 1:
                 PORTAbits.RA4 = 0;
